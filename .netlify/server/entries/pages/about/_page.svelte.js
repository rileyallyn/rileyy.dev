...
const css = {
  code: ".fa-icon.svelte-bw0zb7{display:inline-block;fill:currentColor}.fa-flip-horizontal.svelte-bw0zb7{transform:scale(-1, 1)}.fa-flip-vertical.svelte-bw0zb7{transform:scale(1, -1)}.fa-spin.svelte-bw0zb7{animation:svelte-bw0zb7-fa-spin 1s 0s infinite linear}.fa-inverse.svelte-bw0zb7{color:#fff}.fa-pulse.svelte-bw0zb7{animation:svelte-bw0zb7-fa-spin 1s infinite steps(8)}@keyframes svelte-bw0zb7-fa-spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}",
  map: null
};
const Svg = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${spread(
    ...
    {
      classes: (spin ? "fa-spin" : "") + " " + (pulse ? "fa-pulse" : "") + " " + (inverse ? "fa-inverse" : "") + " " + (flip === "horizontal" ? "fa-flip-horizontal" : "") + " " + (flip === "vertical" ? "fa-flip-vertical" : "") + " svelte-bw0zb7"
    }
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Container, "Container").$$render($$result, {}, {}, {
    default: () => {
      return `<aside class="border-r-2 w-1/5 h-full"><nav class="mr-5 h-full flex flex-col"><ul class="flex flex-col gap-4 p-4 text-white"><li class="p-2"><button><span>Who am I?</span></button></li>
				<li class="p-2"><button><span>What I&#39;ve done</span></button></li>
				<li class="p-2"><button><span>Current technologies</span></button></li></ul>
			<ul class="flex flex-row mt-auto p-4 text-slate-400 gap-4"><li aria-label="github logo"><a href="https://github.com/qpixel">${validate_component(Icon, "Icon").$$render($$result, { data: github, class: "w-7 h-7" }, {}, {})}</a></li>
				<li aria-label="twitter logo"><a href="https://twitter.com/thatqpixel">${validate_component(Icon, "Icon").$$render($$result, { data: twitter, class: "w-7 h-7" }, {}, {})}</a></li></ul></nav></aside>`;
    }
  })}`;
});
export {
